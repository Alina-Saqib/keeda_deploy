      ...
      <div className="grid grid-cols-1 gap-6 @4xl:grid-cols-2 @7xl:grid-cols-12 3xl:gap-8">
        ...
        >
          <div className="flex gap-4">
            <div className="mb-4">
              <Link href={routes.business.addOutlet} className="inline-flex">
                <Button
                  tag="span"
                  className="h-[38px] shadow dark:bg-gray-100 dark:text-gray-900 md:h-10"
                >
                  <PiPlusBold className="me-1 h-4 w-4" /> Add Outlet
                </Button>
              </Link>
            </div>
            <div className="mb-4">
              <Link href={routes.business.addMenu} className="inline-flex">
                <Button
                  tag="span"
                  className="h-[38px] shadow dark:bg-gray-100 dark:text-gray-900 md:h-10"
                >
                  <PiPlusBold className="me-1 h-4 w-4" /> Add Menu
                </Button>
              </Link>
            </div>
            <div className="mb-4">
              ...
              >
                <Button
                  ...
                  className="h-[38px] shadow dark:bg-gray-100 dark:text-gray-900 md:h-10"
                >
                  <PiPlusBold className="me-1 h-4 w-4" /> Add Category
                </Button>
              </Link>
            </div>
            <div className="mb-4">
