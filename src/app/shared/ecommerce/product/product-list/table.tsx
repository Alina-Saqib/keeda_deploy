...
import { getAllProducts, getSpecificCategoryProducts } from '@/api-handler/api';
...
export default function ProductsTable({ id }: { id?: string }) {
  ...
  const fetchData = async () => {
    try {
      if (id) {
        const response = await getSpecificCategoryProducts(id);
        if (response) {
