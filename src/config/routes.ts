export const routes = {
  eCommerce: {
    ...
    specificMenuCategores: (id: string) =>
      `/ecommerce/menucategories/${id}/categories`,
    specificCategoryProduct: (slug: string) =>
      `/ecommerce/products/${slug}/viewproduct`,
  ...
  blank: '/blank',
  business: {
    addOutlet: '/business-info/add-outlet',
    addMenu: '/business-info/add-menu',
    editMenu: (id: string) => `/business-info/add-menu/${id}/edit`,
  },
  auth: {
