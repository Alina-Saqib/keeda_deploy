...
export const productFormSchema = z.object({
  ...
  categories: z.string().min(1, { message: messages.categoryIsRequired }),
  outlet: z.string().min(1, { message: messages.outletIsRequired }),
  fulfilmentMethod: z.string().min(1, { message: messages.fulfilIsRequired }),
  ...
  productVariants: z
    ...
    .min(1, { message: messages.variantIsRequired }),
  tags: z.array(z.string()).min(1, { message: messages.tagIsRequired }),
